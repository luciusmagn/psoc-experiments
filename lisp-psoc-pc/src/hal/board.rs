...
impl lisp::Board for PsocBoard<'_> {
    ...
    fn save_file_bytes(
        ...
        let report =
            lisp_fat::write_file_bytes(self.p, path, &content.bytes[..content.len as usize]);
        lisp::StoreWriteReport {
            ready: matches!(report.status, lisp_fat::FatStatus::Ready),
            status: fat_status(report.status),
            path_len: report.path_len,
    ...
    fn wifi_dhcp_acquire(&mut self) -> lisp::WifiSdioDhcpAcquireReport {
        wifi_sdio_dhcp_acquire_report(wifi_sdio::dhcp_acquire(
            self.p,
            &mut self.state.wifi_control_state,
        ))
    }
    ...
    fn wifi_arp_router(&mut self) -> lisp::WifiSdioArpRouterReport {
        wifi_sdio_arp_router_report(wifi_sdio::arp_router(
            self.p,
            &mut self.state.wifi_control_state,
        ))
    }

    fn wifi_dns_query(&mut self, name: lisp::StringBytes) -> lisp::WifiSdioDnsQueryReport {
        wifi_sdio_dns_query_report(wifi_sdio::dns_query(
            self.p,
            &mut self.state.wifi_control_state,
    ...
    fn wifi_tcp_receive_once(
        &mut self,
        port: u16,
        poll_frames: u8,
    ) -> lisp::WifiSdioTcpReceiveReport {
        wifi_sdio_tcp_receive_report(wifi_sdio::tcp_receive_once(
            self.p,
            &mut self.state.wifi_control_state,
            port,
            poll_frames,
    ...
    fn wifi_net_repl_reply(
        ...
        sequence: u32,
        payload: lisp::NetReplResponseBytes,
    ) -> lisp::WifiNetReplReplyReport {
        wifi_sdio_net_repl_reply_report(wifi_sdio::net_repl_reply(
            self.p,
            &mut self.state.wifi_control_state,
            sequence,
            &payload.bytes[..payload.len as usize],
...
fn wifi_sdio_dhcp_acquire_status(status: wifi_sdio::WifiSdioDhcpAcquireStatus) -> &'static [u8] {
    match status {
        wifi_sdio::WifiSdioDhcpAcquireStatus::Ready => b"ready",
        wifi_sdio::WifiSdioDhcpAcquireStatus::HtRequestFailed => b"ht-request-failed",
        wifi_sdio::WifiSdioDhcpAcquireStatus::MacReadFailed => b"mac-read-failed",
        wifi_sdio::WifiSdioDhcpAcquireStatus::MacMissing => b"mac-missing",
        wifi_sdio::WifiSdioDhcpAcquireStatus::DiscoverSendFailed => b"discover-send-failed",
        wifi_sdio::WifiSdioDhcpAcquireStatus::OfferPollFailed => b"offer-poll-failed",
        wifi_sdio::WifiSdioDhcpAcquireStatus::OfferTimeout => b"offer-timeout",
        wifi_sdio::WifiSdioDhcpAcquireStatus::OfferMissingServer => b"offer-missing-server",
        wifi_sdio::WifiSdioDhcpAcquireStatus::RequestSendFailed => b"request-send-failed",
...
fn wifi_sdio_arp_router_status(status: wifi_sdio::WifiSdioArpRouterStatus) -> &'static [u8] {
    match status {
        wifi_sdio::WifiSdioArpRouterStatus::Ready => b"ready",
        wifi_sdio::WifiSdioArpRouterStatus::NoLease => b"no-lease",
        wifi_sdio::WifiSdioArpRouterStatus::LeaseMissingAddress => b"lease-missing-address",
        wifi_sdio::WifiSdioArpRouterStatus::HtRequestFailed => b"ht-request-failed",
        wifi_sdio::WifiSdioArpRouterStatus::MacReadFailed => b"mac-read-failed",
        wifi_sdio::WifiSdioArpRouterStatus::MacMissing => b"mac-missing",
        wifi_sdio::WifiSdioArpRouterStatus::RequestSendFailed => b"request-send-failed",
        wifi_sdio::WifiSdioArpRouterStatus::ReplyPollFailed => b"reply-poll-failed",
        wifi_sdio::WifiSdioArpRouterStatus::ReplyTimeout => b"reply-timeout",
    }
}

fn wifi_sdio_arp_poll_status(status: wifi_sdio::WifiSdioArpPollStatus) -> &'static [u8] {
    match status {
        wifi_sdio::WifiSdioArpPollStatus::NotRun => b"not-run",
        wifi_sdio::WifiSdioArpPollStatus::Ready => b"ready",
        wifi_sdio::WifiSdioArpPollStatus::Timeout => b"timeout",
        wifi_sdio::WifiSdioArpPollStatus::AckFailed => b"ack-failed",
        wifi_sdio::WifiSdioArpPollStatus::FrameReadFailed => b"frame-read-failed",
        wifi_sdio::WifiSdioArpPollStatus::InvalidFrame => b"invalid-frame",
    }
}

fn wifi_sdio_arp_parse_status(status: wifi_sdio::WifiSdioArpParseStatus) -> &'static [u8] {
    match status {
        wifi_sdio::WifiSdioArpParseStatus::NotRun => b"not-run",
        wifi_sdio::WifiSdioArpParseStatus::Ready => b"ready",
        wifi_sdio::WifiSdioArpParseStatus::EmptyFrame => b"empty-frame",
        wifi_sdio::WifiSdioArpParseStatus::NonDataChannel => b"non-data-channel",
        wifi_sdio::WifiSdioArpParseStatus::BdcHeaderTooShort => b"bdc-header-too-short",
        wifi_sdio::WifiSdioArpParseStatus::EthernetTooShort => b"ethernet-too-short",
        wifi_sdio::WifiSdioArpParseStatus::WrongEtherType => b"wrong-ethertype",
        wifi_sdio::WifiSdioArpParseStatus::ArpTooShort => b"arp-too-short",
        wifi_sdio::WifiSdioArpParseStatus::WrongHardware => b"wrong-hardware",
        wifi_sdio::WifiSdioArpParseStatus::WrongProtocol => b"wrong-protocol",
        wifi_sdio::WifiSdioArpParseStatus::WrongOperation => b"wrong-operation",
        wifi_sdio::WifiSdioArpParseStatus::WrongSender => b"wrong-sender",
        wifi_sdio::WifiSdioArpParseStatus::WrongTarget => b"wrong-target",
    }
}
...
fn wifi_sdio_dns_query_status(status: wifi_sdio::WifiSdioDnsQueryStatus) -> &'static [u8] {
    match status {
        ...
        wifi_sdio::WifiSdioDnsQueryStatus::RouterMacMissing => b"router-mac-missing",
        wifi_sdio::WifiSdioDnsQueryStatus::HtRequestFailed => b"ht-request-failed",
        wifi_sdio::WifiSdioDnsQueryStatus::MacReadFailed => b"mac-read-failed",
        wifi_sdio::WifiSdioDnsQueryStatus::MacMissing => b"mac-missing",
        wifi_sdio::WifiSdioDnsQueryStatus::BadName => b"bad-name",
        wifi_sdio::WifiSdioDnsQueryStatus::SendFailed => b"send-failed",
        wifi_sdio::WifiSdioDnsQueryStatus::ResponsePollFailed => b"response-poll-failed",
        wifi_sdio::WifiSdioDnsQueryStatus::ResponseTimeout => b"response-timeout",
        wifi_sdio::WifiSdioDnsQueryStatus::NoAnswer => b"no-answer",
    }
}

fn wifi_sdio_dns_poll_status(status: wifi_sdio::WifiSdioDnsPollStatus) -> &'static [u8] {
    match status {
        wifi_sdio::WifiSdioDnsPollStatus::NotRun => b"not-run",
        wifi_sdio::WifiSdioDnsPollStatus::Ready => b"ready",
        wifi_sdio::WifiSdioDnsPollStatus::Timeout => b"timeout",
        wifi_sdio::WifiSdioDnsPollStatus::AckFailed => b"ack-failed",
        wifi_sdio::WifiSdioDnsPollStatus::FrameReadFailed => b"frame-read-failed",
        wifi_sdio::WifiSdioDnsPollStatus::InvalidFrame => b"invalid-frame",
    }
}

fn wifi_sdio_dns_parse_status(status: wifi_sdio::WifiSdioDnsParseStatus) -> &'static [u8] {
    match status {
        wifi_sdio::WifiSdioDnsParseStatus::NotRun => b"not-run",
        wifi_sdio::WifiSdioDnsParseStatus::Ready => b"ready",
        wifi_sdio::WifiSdioDnsParseStatus::EmptyFrame => b"empty-frame",
        wifi_sdio::WifiSdioDnsParseStatus::NonDataChannel => b"non-data-channel",
        wifi_sdio::WifiSdioDnsParseStatus::BdcHeaderTooShort => b"bdc-header-too-short",
        wifi_sdio::WifiSdioDnsParseStatus::EthernetTooShort => b"ethernet-too-short",
        wifi_sdio::WifiSdioDnsParseStatus::WrongEtherType => b"wrong-ethertype",
        wifi_sdio::WifiSdioDnsParseStatus::NotIpv4 => b"not-ipv4",
        wifi_sdio::WifiSdioDnsParseStatus::NotUdp => b"not-udp",
        wifi_sdio::WifiSdioDnsParseStatus::WrongAddress => b"wrong-address",
        wifi_sdio::WifiSdioDnsParseStatus::WrongPorts => b"wrong-ports",
        wifi_sdio::WifiSdioDnsParseStatus::UdpTooShort => b"udp-too-short",
        wifi_sdio::WifiSdioDnsParseStatus::DnsTooShort => b"dns-too-short",
        wifi_sdio::WifiSdioDnsParseStatus::WrongTransaction => b"wrong-transaction",
        wifi_sdio::WifiSdioDnsParseStatus::NotResponse => b"not-response",
...
fn wifi_sdio_tcp_receive_status(status: wifi_sdio::WifiSdioTcpReceiveStatus) -> &'static [u8] {
    match status {
        ...
        wifi_sdio::WifiSdioTcpReceiveStatus::BadPort => b"bad-port",
        wifi_sdio::WifiSdioTcpReceiveStatus::HtRequestFailed => b"ht-request-failed",
        wifi_sdio::WifiSdioTcpReceiveStatus::ListenPollFailed => b"listen-poll-failed",
        wifi_sdio::WifiSdioTcpReceiveStatus::ListenTimeout => b"listen-timeout",
        wifi_sdio::WifiSdioTcpReceiveStatus::SynRejected => b"syn-rejected",
        wifi_sdio::WifiSdioTcpReceiveStatus::SynAckSendFailed => b"syn-ack-send-failed",
        wifi_sdio::WifiSdioTcpReceiveStatus::AckPollFailed => b"ack-poll-failed",
        wifi_sdio::WifiSdioTcpReceiveStatus::AckTimeout => b"ack-timeout",
        wifi_sdio::WifiSdioTcpReceiveStatus::AckRejected => b"ack-rejected",
...
fn wifi_sdio_net_repl_request_status(
    status: wifi_sdio::WifiSdioNetReplRequestStatus,
) -> &'static [u8] {
    match status {
        ...
        wifi_sdio::WifiSdioNetReplRequestStatus::AckFailed => b"ack-failed",
        wifi_sdio::WifiSdioNetReplRequestStatus::FrameReadFailed => b"frame-read-failed",
        wifi_sdio::WifiSdioNetReplRequestStatus::InvalidFrame => b"invalid-frame",
        wifi_sdio::WifiSdioNetReplRequestStatus::Timeout => b"timeout",
    }
}

fn wifi_sdio_net_repl_parse_status(status: wifi_sdio::WifiSdioNetReplParseStatus) -> &'static [u8] {
    match status {
        ...
        wifi_sdio::WifiSdioNetReplParseStatus::EthernetTooShort => b"ethernet-too-short",
        wifi_sdio::WifiSdioNetReplParseStatus::WrongEtherType => b"wrong-ethertype",
        wifi_sdio::WifiSdioNetReplParseStatus::NotIpv4 => b"not-ipv4",
        wifi_sdio::WifiSdioNetReplParseStatus::NotUdp => b"not-udp",
        wifi_sdio::WifiSdioNetReplParseStatus::WrongAddress => b"wrong-address",
        wifi_sdio::WifiSdioNetReplParseStatus::WrongPort => b"wrong-port",
        wifi_sdio::WifiSdioNetReplParseStatus::UdpTooShort => b"udp-too-short",
...
fn wifi_sdio_net_repl_reply_status(status: wifi_sdio::WifiSdioNetReplReplyStatus) -> &'static [u8] {
    match status {
        wifi_sdio::WifiSdioNetReplReplyStatus::Ready => b"ready",
        wifi_sdio::WifiSdioNetReplReplyStatus::NoLease => b"no-lease",
        wifi_sdio::WifiSdioNetReplReplyStatus::LeaseMissingAddress => b"lease-missing-address",
        wifi_sdio::WifiSdioNetReplReplyStatus::NoPeer => b"no-peer",
        wifi_sdio::WifiSdioNetReplReplyStatus::HtRequestFailed => b"ht-request-failed",
        wifi_sdio::WifiSdioNetReplReplyStatus::MacReadFailed => b"mac-read-failed",
        wifi_sdio::WifiSdioNetReplReplyStatus::MacMissing => b"mac-missing",
        wifi_sdio::WifiSdioNetReplReplyStatus::PayloadTooLarge => b"payload-too-large",
        wifi_sdio::WifiSdioNetReplReplyStatus::SendFailed => b"send-failed",
    }
}

fn wifi_sdio_dhcp_poll_status(status: wifi_sdio::WifiSdioDhcpPollStatus) -> &'static [u8] {
    match status {
        wifi_sdio::WifiSdioDhcpPollStatus::NotRun => b"not-run",
        wifi_sdio::WifiSdioDhcpPollStatus::Ready => b"ready",
        wifi_sdio::WifiSdioDhcpPollStatus::Timeout => b"timeout",
        wifi_sdio::WifiSdioDhcpPollStatus::AckFailed => b"ack-failed",
        wifi_sdio::WifiSdioDhcpPollStatus::FrameReadFailed => b"frame-read-failed",
        wifi_sdio::WifiSdioDhcpPollStatus::InvalidFrame => b"invalid-frame",
        wifi_sdio::WifiSdioDhcpPollStatus::NakReceived => b"nak-received",
    }
}

fn wifi_sdio_dhcp_parse_status(status: wifi_sdio::WifiSdioDhcpParseStatus) -> &'static [u8] {
    match status {
        wifi_sdio::WifiSdioDhcpParseStatus::NotRun => b"not-run",
        wifi_sdio::WifiSdioDhcpParseStatus::Ready => b"ready",
        wifi_sdio::WifiSdioDhcpParseStatus::EmptyFrame => b"empty-frame",
        wifi_sdio::WifiSdioDhcpParseStatus::NonDataChannel => b"non-data-channel",
        wifi_sdio::WifiSdioDhcpParseStatus::BdcHeaderTooShort => b"bdc-header-too-short",
        wifi_sdio::WifiSdioDhcpParseStatus::EthernetTooShort => b"ethernet-too-short",
        wifi_sdio::WifiSdioDhcpParseStatus::WrongEtherType => b"wrong-ethertype",
        wifi_sdio::WifiSdioDhcpParseStatus::NotIpv4 => b"not-ipv4",
        wifi_sdio::WifiSdioDhcpParseStatus::NotUdp => b"not-udp",
        wifi_sdio::WifiSdioDhcpParseStatus::WrongPorts => b"wrong-ports",
        wifi_sdio::WifiSdioDhcpParseStatus::DhcpTooShort => b"dhcp-too-short",
        wifi_sdio::WifiSdioDhcpParseStatus::WrongOp => b"wrong-op",
        wifi_sdio::WifiSdioDhcpParseStatus::WrongTransaction => b"wrong-transaction",
        wifi_sdio::WifiSdioDhcpParseStatus::WrongClient => b"wrong-client",
        wifi_sdio::WifiSdioDhcpParseStatus::MissingMessageType => b"missing-message-type",
        wifi_sdio::WifiSdioDhcpParseStatus::UnwantedMessageType => b"unwanted-message-type",
        wifi_sdio::WifiSdioDhcpParseStatus::TruncatedOptions => b"truncated-options",
    }
}
...
fn wifi_sdio_dhcp_acquire_report(
    report: wifi_sdio::WifiSdioDhcpAcquireReport,
) -> lisp::WifiSdioDhcpAcquireReport {
    lisp::WifiSdioDhcpAcquireReport {
        status: wifi_sdio_dhcp_acquire_status(report.status),
        step: report.step,
        ht_status: wifi_sdio_ht_request_status(report.ht_status),
        ht_attempts: report.ht_attempts,
        ht_write_response: report.ht_write_response,
        ...
        mac_cdc_length: report.mac_cdc_length,
        transaction_id: report.transaction_id,
        discover_status: wifi_sdio_f2_control_status(report.discover_status),
        discover_packet_length: report.discover_packet_length,
        discover_write_response: report.discover_write_response,
        offer_poll_status: wifi_sdio_dhcp_poll_status(report.offer_poll_status),
        offer_parse_status: wifi_sdio_dhcp_parse_status(report.offer_parse_status),
        offer_polls: report.offer_polls,
        offer_frames_read: report.offer_frames_read,
        offer_non_data_frames: report.offer_non_data_frames,
        offer_non_dhcp_frames: report.offer_non_dhcp_frames,
        offer_message_type: report.offer_message_type,
        offered_ip_address: report.offered_ip_address,
        ...
        ack_poll_status: wifi_sdio_dhcp_poll_status(report.ack_poll_status),
        ack_parse_status: wifi_sdio_dhcp_parse_status(report.ack_parse_status),
        ack_polls: report.ack_polls,
        ack_frames_read: report.ack_frames_read,
        ack_non_data_frames: report.ack_non_data_frames,
        ack_non_dhcp_frames: report.ack_non_dhcp_frames,
        ack_message_type: report.ack_message_type,
        leased_ip_address: report.leased_ip_address,
...
fn wifi_sdio_arp_router_report(
    report: wifi_sdio::WifiSdioArpRouterReport,
) -> lisp::WifiSdioArpRouterReport {
    lisp::WifiSdioArpRouterReport {
        status: wifi_sdio_arp_router_status(report.status),
        step: report.step,
        lease_valid: report.lease_valid,
        local_ip_address: report.local_ip_address,
        router_ip_address: report.router_ip_address,
        ht_status: wifi_sdio_ht_request_status(report.ht_status),
        ht_attempts: report.ht_attempts,
        ht_write_response: report.ht_write_response,
        ht_read_value: report.ht_read_value,
        ...
        request_packet_length: report.request_packet_length,
        request_write_response: report.request_write_response,
        reply_poll_status: wifi_sdio_arp_poll_status(report.reply_poll_status),
        reply_parse_status: wifi_sdio_arp_parse_status(report.reply_parse_status),
        reply_polls: report.reply_polls,
        reply_frames_read: report.reply_frames_read,
        reply_non_data_frames: report.reply_non_data_frames,
        reply_non_arp_frames: report.reply_non_arp_frames,
        router_mac_hash: report.router_mac_hash,
        router_mac_present: report.router_mac_present,
        router_mac_stored: report.router_mac_stored,
        ack_status: wifi_sdio_interrupt_ack_status(report.ack_status),
        ack_last_error: report.ack_last_error.map(wifi_sdio_command_error_report),
        ht_last_error: report.ht_last_error.map(wifi_sdio_command_error_report),
        request_last_error: report
...
fn wifi_sdio_dns_query_report(
    report: wifi_sdio::WifiSdioDnsQueryReport,
) -> lisp::WifiSdioDnsQueryReport {
    lisp::WifiSdioDnsQueryReport {
        status: wifi_sdio_dns_query_status(report.status),
        step: report.step,
        lease_valid: report.lease_valid,
        local_ip_address: report.local_ip_address,
        dns_server_ip_address: report.dns_server_ip_address,
        router_ip_address: report.router_ip_address,
        router_mac_present: report.router_mac_present,
        ht_status: wifi_sdio_ht_request_status(report.ht_status),
        ht_attempts: report.ht_attempts,
        ...
        mac_cdc_length: report.mac_cdc_length,
        transaction_id: report.transaction_id,
        query_name_length: report.query_name_length,
        query_payload_length: report.query_payload_length,
        query_payload_hash: report.query_payload_hash,
        request_status: wifi_sdio_f2_control_status(report.request_status),
        request_ethernet_length: report.request_ethernet_length,
        request_ethernet_hash: report.request_ethernet_hash,
        request_packet_length: report.request_packet_length,
        request_write_response: report.request_write_response,
        response_poll_status: wifi_sdio_dns_poll_status(report.response_poll_status),
        response_parse_status: wifi_sdio_dns_parse_status(report.response_parse_status),
        ...
        response_non_dns_frames: report.response_non_dns_frames,
        response_answer_count: report.response_answer_count,
        answer_ip_address: report.answer_ip_address,
        answer_ttl_seconds: report.answer_ttl_seconds,
        answer_valid: report.answer_valid,
        ack_status: wifi_sdio_interrupt_ack_status(report.ack_status),
        ack_last_error: report.ack_last_error.map(wifi_sdio_command_error_report),
        ht_last_error: report.ht_last_error.map(wifi_sdio_command_error_report),
        request_last_error: report
...
fn wifi_sdio_tcp_receive_report(
    report: wifi_sdio::WifiSdioTcpReceiveReport,
) -> lisp::WifiSdioTcpReceiveReport {
    lisp::WifiSdioTcpReceiveReport {
        status: wifi_sdio_tcp_receive_status(report.status),
        step: report.step,
        local_ip_address: report.local_ip_address,
        listen_port: report.listen_port,
        peer_ip_address: report.peer_ip_address,
        ...
        ack_polls: report.ack_polls,
        ack_frames_read: report.ack_frames_read,
        payload_poll_status: wifi_sdio_tcp_poll_status(report.payload_poll_status),
        payload_parse_status: wifi_sdio_tcp_parse_status(report.payload_parse_status),
        payload_polls: report.payload_polls,
        payload_frames_read: report.payload_frames_read,
...
fn wifi_sdio_net_repl_request_report(
    report: wifi_sdio::WifiSdioNetReplRequestReport,
) -> lisp::WifiNetReplRequestReport {
    lisp::WifiNetReplRequestReport {
        status: wifi_sdio_net_repl_request_status(report.status),
        step: report.step,
        lease_valid: report.lease_valid,
        local_ip_address: report.local_ip_address,
        ht_status: wifi_sdio_ht_request_status(report.ht_status),
        ...
        ht_read_response: report.ht_read_response,
        ht_available: report.ht_available,
        parse_status: wifi_sdio_net_repl_parse_status(report.parse_status),
        poll_limit: report.poll_limit,
        polls: report.polls,
        frames_read: report.frames_read,
        non_data_frames: report.non_data_frames,
        non_repl_frames: report.non_repl_frames,
        source_ip_address: report.source_ip_address,
        source_port: report.source_port,
...
fn wifi_sdio_net_repl_reply_report(
    report: wifi_sdio::WifiSdioNetReplReplyReport,
) -> lisp::WifiNetReplReplyReport {
    lisp::WifiNetReplReplyReport {
        status: wifi_sdio_net_repl_reply_status(report.status),
        step: report.step,
        lease_valid: report.lease_valid,
        local_ip_address: report.local_ip_address,
        peer_valid: report.peer_valid,
        ...
        ack_status: wifi_sdio_interrupt_ack_status(report.ack_status),
        ht_last_error: report.ht_last_error.map(wifi_sdio_command_error_report),
        mac_last_error: report.mac_last_error.map(wifi_sdio_command_error_report),
        send_last_error: report.send_last_error.map(wifi_sdio_command_error_report),
        host_normal_int: report.host_normal_int,
        host_error_int: report.host_error_int,
    }
