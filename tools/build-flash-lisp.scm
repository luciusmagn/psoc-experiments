...
(let ((args (command-line-tail)))
  (when (and (pair? args) (string=? (car args) "--help"))
    (say "usage: tools/build-flash-lisp.scm [--wifi-firmware] [--wifi-credentials] [--wifi-boot-smoke] [--wifi-dhcp-boot-smoke] [--wifi-arp-boot-smoke] [--storage-boot-smoke] [--storage-format-boot-smoke] [flash-lisp arguments]")
    (say "")
